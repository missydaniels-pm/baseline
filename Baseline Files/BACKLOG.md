...
|---|---|---|---|
| Episode Logging | Future episode dates — remove or keep with documented reason? | Lizz | ✅ Reviewed 7/14/26 — **keep blocked.** Episodes are logged as they happen or retroactively; future-dated episodes aren't needed. The existing frontend + backend block stands as-is, no change required. |
